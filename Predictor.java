 ...
 * Task2 Building a Language Model for the Input Text Predictor
 *
 * This file rank the n+1gram to a ngram phrase according to their conditional probability
 *
 * Hao Wang - haow2
 */
...
public class Predictor {
    public static class PredictorMapper extends Mapper<Object, Text, Text, Text>{
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String key_s = lines[0].substring(0, lines[0].lastIndexOf(" " + words[words.length-1])).trim();

            // The value is the last word and the num of occurance
            String value_s = words[words.length-1] + ":" + num;
    ...
    public static class PredictorReducer extends Reducer<Text, Text, ImmutableBytesWritable, Put> {

        private int gc_count = 0;
        private byte[] column_family = Bytes.toBytes("phrase_rank");
